    ...
    <div className="quiz-page quiz-admin-page" dir={isRtl ? "rtl" : "ltr"}>
      <div className="quiz-header">
        <div className="quiz-header-top">
          <div>
            <div className="quiz-title">{t("Quiz.admin.title")}</div>
            <div className="quiz-subtitle">{t("Quiz.admin.subtitle")}</div>
          </div>
          <div className="quiz-admin-header-actions">
            <Link to="/Quiz" className="quiz-admin-link">{t("Quiz.admin.backToQuiz")}</Link>
            {authenticated && (
